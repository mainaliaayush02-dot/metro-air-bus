...
const EMPTY_FORM = { busName: 'New Metro VIP Sofa', busNumber: '' }
...
export default function ManageBuses() {
  ...
  function openEdit(bus) {
    setEditingId(bus.id)
    setForm({ busName: bus.busName, busNumber: bus.busNumber })
    setError('')
    setModalOpen(true)
  }
  ...
  async function handleSubmit(e) {
    ...
    setSaving(true)
    try {
      const payload = { busName: form.busName.trim(), busNumber: form.busNumber.trim() }
      if (editingId) {
